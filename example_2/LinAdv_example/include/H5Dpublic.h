 ...
 * \param[in] point std::vector containing the location of the element within
 ...
 *
 * \dset_id
 * \param[in] size[]   std::vector containing the new magnitude of each dimension
 *                     of the dataset
 *
 * \return \herr_t
 *
 ...
 *
 * \dset_id
 * \param[in] size std::vector containing the new size of each dimension
 *
 * \return \herr_t
 *
