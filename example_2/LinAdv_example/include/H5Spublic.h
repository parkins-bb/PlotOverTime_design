 ...
 * \param[in] dims    std::vector specifying the size of each dimension
 * \param[in] maxdims std::vector specifying the maximum size of each dimension
 *
 * \return \hid_t{dataspace}
 *
 ...
 * \param[out] off      std::vector of sequence offsets
 * \param[out] len      std::vector of sequence lengths
 *
 * \return \herr_t
 *
 ...
 * \param[in] dims   std::vector containing current size of dataspace
 * \param[in] max    std::vector containing maximum size of dataspace
 *
 * \return \herr_t
 *
