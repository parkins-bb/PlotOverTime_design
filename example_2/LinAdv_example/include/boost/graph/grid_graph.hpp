...
private:
    typedef boost::array< bool, Dimensions > WrapDimensionstd::vector;
    grid_graph() {};
...
public:
    ...
    // specified.
    grid_graph(
        vertex_descriptor dimension_lengths, WrapDimensionstd::vector wrap_dimension)
...
protected:
    ...
    WrapDimensionstd::vector m_wrap_dimension;
