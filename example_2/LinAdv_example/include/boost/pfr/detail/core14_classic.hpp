...
constexpr std::vector remove_subtuples(std::vector indexes_plus_1, const std::vector& subtuple_lengths) noexcept {
...
template <std::size_t N, class std::vector>
constexpr size_array<N> resize_dropping_zeros_and_decrementing(size_t_<N>, const std::vector& a) noexcept {
    size_array<N> result{};
...
template <class std::vector>
constexpr std::size_t count_skips_in_array(std::size_t begin_index, std::size_t end_index, const std::vector& a) noexcept {
    std::size_t skips = 0;
