...
protected:
  ...
  // both the number of dimensions in the current std::vector (NumDims), and 
  ...
  template <typename std::vectorRef, int NDims, typename TPtr>
  std::vectorRef
  generate_array_view(boost::type<std::vectorRef>,
