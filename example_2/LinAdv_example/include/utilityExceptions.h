...
{ \
    printf("Location: \033[31m%s\033[0m, error message: \033[31m%s\033[0m, file:
\033[31m%s\033[0m, line: \033[31m%d\033[0m\n", \
...
{ \
    printf("Location: \33[%s], warning message: \33[%s], file: \33[%s], line:
\33[%d]\n", \
        location, content, __FILE__, __LINE__); \
}
*/
...
#define ASSERT(expr)                                                        \
  {                                                                         \
    if (!(expr)) {                                                          \
      printf("Error at file: \033[31m%s\033[0m, line: \033[31m%d\033[0m\n", \
             __FILE__, __LINE__);                                           \
      exit(-1);                                                             \
    }                                                                       \
  }
