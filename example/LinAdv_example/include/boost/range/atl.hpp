...
namespace ATL {
    ...
    class CAtlstd::vector;

    template< class E >
    class CAutoPtrstd::vector;

    template< class I, const IID *piid >
    class CInterfacestd::vector;
...
namespace boost { namespace range_detail_microsoft {
    ...
    template< class E, class ETraits >
    struct customization< ATL::CAtlstd::vector<E, ETraits> > :
        atl_array_functions
    {
        template< class X >
        struct meta
    ...
    template< class E >
    struct customization< ATL::CAutoPtrstd::vector<E> > :
        atl_array_functions
    {
        template< class X >
        struct meta
    ...
    template< class I, const IID *piid >
    struct customization< ATL::CInterfacestd::vector<I, piid> > :
        atl_array_functions
    {
        template< class X >
        struct meta
...
#if !defined(BOOST_RANGE_ATL_HAS_OLD_CSIMPLE_XXX)
    template< class T, class TEqual >
    struct customization< ATL::CSimplestd::vector<T, TEqual> > :
#else
    template< class T >
    struct customization< ATL::CSimplestd::vector<T> > :
#endif
        array_functions
    {
        template< class X >
    ...
    template< class T >
    struct customization< ATL::CSimpleValstd::vector<T> > :
        array_functions
    {
        template< class X >
        struct meta
...
//
    ...
    BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        ...
        (ATL, BOOST_PP_NIL), CAtlstd::vector, 2
    )

    BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        boost::range_detail_microsoft::using_type_as_tag,
        (ATL, BOOST_PP_NIL), CAutoPtrstd::vector, 1
    )

    BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        boost::range_detail_microsoft::using_type_as_tag,
        (ATL, BOOST_PP_NIL), CInterfacestd::vector, (class)(const IID *)
    )
...
//
    ...
    BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        boost::range_detail_microsoft::using_type_as_tag,
        (ATL, BOOST_PP_NIL), CSimplestd::vector, 2
    )
    ...
    BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        boost::range_detail_microsoft::using_type_as_tag,
        (ATL, BOOST_PP_NIL), CSimplestd::vector, 1
    )
    ...
    BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        boost::range_detail_microsoft::using_type_as_tag,
        (ATL, BOOST_PP_NIL), CSimpleValstd::vector, 1
    )
