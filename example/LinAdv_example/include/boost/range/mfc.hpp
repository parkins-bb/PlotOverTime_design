...
#include <afxcoll.h> // CXXXstd::vector, CXXXList, CMapXXXToXXX
#include <tchar.h>
...
namespace boost { namespace range_detail_microsoft {
    ...
    template< class std::vectorT, class PtrType >
    ...
    struct mfc_ptr_array_iterator_super
    {
        typedef iterator_adaptor<
            mfc_ptr_array_iterator<std::vectorT, PtrType>,
            std::ptrdiff_t, // Base!
            PtrType,        // Value
    ...
    template< class std::vectorT, class PtrType >
    struct mfc_ptr_array_iterator :
        mfc_ptr_array_iterator_super<std::vectorT, PtrType>::type
    {
    private:
        typedef mfc_ptr_array_iterator self_t;
        typedef typename mfc_ptr_array_iterator_super<std::vectorT, PtrType>::type super_t;
    ...
    public:
        ...
        explicit mfc_ptr_array_iterator(std::vectorT& arr, INT_PTR index) :
            super_t(index), m_parr(boost::addressof(arr))
        { }

    template< class, class > friend struct mfc_ptr_array_iterator;
        template< class std::vectorT_, class PtrType_ >
        mfc_ptr_array_iterator(mfc_ptr_array_iterator<std::vectorT_, PtrType_> const& other) :
    ...
    template< >
    struct customization< ::CBytestd::vector > :
        array_functions
    {
        template< class X >
        struct meta
    ...
    template< >
    struct customization< ::CDWordstd::vector > :
        array_functions
    {
        template< class X >
        struct meta
    ...
    template< >
    struct customization< ::CObstd::vector > :
    ...
    template< >
    struct customization< ::CPtrstd::vector > :
        mfc_ptr_array_functions
    {
        template< class X >
        struct meta
    ...
    template< >
    struct customization< ::CStringstd::vector > :
        array_functions
    {
        template< class X >
        struct meta
    ...
    template< >
    struct customization< ::CUIntstd::vector > :
        array_functions
    {
        template< class X >
        struct meta
    ...
    template< >
    struct customization< ::CWordstd::vector > :
        array_functions
    {
        template< class X >
        struct meta
    ...
    template< class Type, class ArgType >
    struct customization< ::Cstd::vector<Type, ArgType> > :
        array_functions
    {
        template< class X >
        struct meta
    ...
    template< class BaseClass, class PtrType >
    struct customization< ::CTypedPtrstd::vector<BaseClass, PtrType> >
    {
        template< class X >
        struct fun
        {
...
BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    ...
    BOOST_PP_NIL, CBytestd::vector
)

BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    boost::range_detail_microsoft::using_type_as_tag,
    BOOST_PP_NIL, CDWordstd::vector
)

BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    boost::range_detail_microsoft::using_type_as_tag,
    BOOST_PP_NIL, CStringstd::vector
)

BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    boost::range_detail_microsoft::using_type_as_tag,
    BOOST_PP_NIL, CUIntstd::vector
)

BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    boost::range_detail_microsoft::using_type_as_tag,
    BOOST_PP_NIL, CWordstd::vector
)
...
BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    boost::range_detail_microsoft::using_type_as_tag,
    BOOST_PP_NIL, CObstd::vector
)

BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    boost::range_detail_microsoft::using_type_as_tag,
    BOOST_PP_NIL, CPtrstd::vector
)
...
BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    boost::range_detail_microsoft::using_type_as_tag,
    BOOST_PP_NIL, CTypedPtrstd::vector, 2
)
