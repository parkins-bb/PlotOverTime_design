...
// std::vector send must send the elements directly
template<typename T>
...
// std::vector receive must receive the elements directly into a buffer.
template<typename T>
...
// std::vector isend must send the elements directly
template<typename T>
