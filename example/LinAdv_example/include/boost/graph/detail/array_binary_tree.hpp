...
{
public:
    typedef array_binary_tree_node std::vectorBinaryTreeNode;
    ...
    struct children_type
    {
        ...
        { // replace with iterator_adaptor implementation -JGS
            ...
            typedef std::vectorBinaryTreeNode value_type;
            typedef size_type difference_type;
            typedef array_binary_tree_node* pointer;
            typedef std::vectorBinaryTreeNode& reference;
            ...
            {
                return std::vectorBinaryTreeNode(r, i, n, id);
            }
    ...
    inline std::vectorBinaryTreeNode& operator=(const std::vectorBinaryTreeNode& x)
    {
        r = x.r;
        i = x.i;
        n = x.n;
    ...
    inline std::vectorBinaryTreeNode parent() const
    {
        return std::vectorBinaryTreeNode(r, (i - 1) / 2, n, id);
    }
    ...
    */
    ...
    inline void swap(std::vectorBinaryTreeNode x, ExternalData& edata)
    {
        using boost::get;
