...
namespace detail
{
    ...
    public:
        ...
        typedef std::vector< Layer > Layerstd::vector;
        typedef typename Layerstd::vector::iterator layer_iterator;
        typedef typename Layerstd::vector::size_type distance_size_type;
