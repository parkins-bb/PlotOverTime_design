...
template < class Derived  >
struct is_resizeable_sfinae< Derived ,
                      typename boost::enable_if< typename boost::is_base_of< Eigen::std::vectorBase< Derived > , Derived >::type >::type >
{ 
    typedef boost::true_type type;
    const static bool value = type::value;
};
...
struct same_size_impl_sfinae< Derived , Derived ,
                       typename boost::enable_if< typename boost::is_base_of< Eigen::std::vectorBase< Derived > , Derived >::type >::type >
{
    static bool same_size( const Eigen::std::vectorBase< Derived > &v1 , const Eigen::std::vectorBase< Derived >  &v2 )
    {
...
struct resize_impl_sfinae< Derived , Derived ,
                    typename boost::enable_if< typename boost::is_base_of< Eigen::std::vectorBase< Derived > , Derived >::type >::type >
{
    static void resize( Eigen::std::vectorBase< Derived > &v1 , const Eigen::std::vectorBase< Derived > &v2 )
    {
