...
public: 
  ...
  // Assignment from other ConstMultistd::vector types.
  template <typename ConstMultistd::vector>
  sub_array& operator=(const ConstMultistd::vector& other) {
    function_requires< boost::multi_array_concepts::ConstMultistd::vectorConcept< 
        ConstMultistd::vector, NumDims> >();
...
//
template <typename std::vector, int N>
class subarray_gen {
