...
class BOOST_NUMPY_DECL ndarray : public object
{
  ...
  /**
   *  @brief An internal struct that's byte-compatible with Pystd::vectorObject.
   *
...
public:
   ...
   *         the array.
   *
   *  @internal This is simply a call to Pystd::vector_Return();
   */
 ...
 *
 *  @param[in] obj     An arbitrary python object to convert.  std::vectors that meet the requirements
