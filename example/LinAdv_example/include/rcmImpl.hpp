#ifndef RCM_CLASSIC_HPP
#define RCM_CLASSIC_HPP
...
bool adj_contains_ij(int node_num, int adj_num, int adj_row[], int adj[], int i,
                     int j);
...
void adj_set(int node_num, int adj_max, int *adj_num, int adj_row[], int adj[],
             int irow, int jcol);
void adj_show(int node_num, int adj_num, int adj_row[], int adj[]);
void degree(label32 root, label32 adj_num, label32 adj_row[], label32 adj[],
            label32 mask[], label32 deg[], label32 *iccsze, label32 ls[],
            label32 node_num);
void degree(label64 root, label64 adj_num, label64 adj_row[], label64 adj[],
            label64 mask[], label64 deg[], label64 *iccsze, label64 ls[],
            label64 node_num);
void genrcm(label32 node_num, label32 adj_num, label32 adj_row[], label32 adj[],
            label32 perm[]);
void genrcm(label64 node_num, label64 adj_num, label64 adj_row[], label64 adj[],
            label64 perm[]);
...
void i4vec_reverse(label32 n, label32 a[]);
void i4vec_reverse(label64 n, label64 a[]);
void i4vec_sort_heap_a(int n, int a[]);
void level_set(label32 root, label32 adj_num, label32 adj_row[], label32 adj[],
               label32 mask[], label32 *level_num, label32 level_row[],
               label32 level[], label32 node_num);
void level_set(label64 root, label64 adj_num, label64 adj_row[], label64 adj[],
               label64 mask[], label64 *level_num, label64 level_row[],
               label64 level[], label64 node_num);
...
void r8mat_transpose_print_some(int m, int n, double a[], int ilo, int jlo,
                                int ihi, int jhi, string title);
void rcm(label32 root, label32 adj_num, label32 adj_row[], label32 adj[],
         label32 mask[], label32 perm[], label32 *iccsze, label32 node_num);
void rcm(label64 root, label64 adj_num, label64 adj_row[], label64 adj[],
         label64 mask[], label64 perm[], label64 *iccsze, label64 node_num);
void root_find(label32 *root, label32 adj_num, label32 adj_row[], label32 adj[],
               label32 mask[], label32 *level_num, label32 level_row[],
               label32 level[], label32 node_num);
void root_find(label64 *root, label64 adj_num, label64 adj_row[], label64 adj[],
               label64 mask[], label64 *level_num, label64 level_row[],
               label64 level[], label64 node_num);
