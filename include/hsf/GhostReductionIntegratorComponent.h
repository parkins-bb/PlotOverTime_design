#ifndef SOURCE_WRAPPER_HSFGHOSTREDUCTIONINTEGRATORCOMPONENT_H
#define SOURCE_WRAPPER_HSFGHOSTREDUCTIONINTEGRATORCOMPONENT_H
...
/**
 * @brief 影像区逐元规约构件类 algs::GhostReductionIntegratorComponent
 * 在单个网格层上, 把数据从影像区规约至网格片内部。
 *
 * 支持结点量、边心量、面心量.
 *
 * 该构件类使用方法如下:
...
template <int DIM>
class GhostReductionIntegratorComponent
 ...
 public:
   ...
   */
  GhostReductionIntegratorComponent(
   ...
   * @brief 析构函数.
   */
  virtual ~GhostReductionIntegratorComponent() {}
 ...
 private:
  ...
  /** 通信调度 */
          ...
          SOURCE_WRAPPER_HSFGHOSTREDUCTIONINTEGRATORCOMPONENT_H */
